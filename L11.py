...
# Cách 1
# from connect_params import SERVER, PORT, USERNAME, PASSWORD, DRIVER, DATABASE, API_KEY
# print(f"My params is: {SERVER}, {PORT}, {USERNAME}, {PASSWORD}, {DRIVER}, {DATABASE}, {API_KEY}")
...
print(f"My Server: {SERVER}, {DATABASE}, {USERNAME}, {PASSWORD}, {DRIVER}")
...
@app.route('/')
def index():
    # return f"My params is: {SERVER}, {PORT}, {USERNAME}, {PASSWORD}, {DRIVER}, {DATABASE}, {API_KEY}"
    # return 'This is a secret page!'
    return f"My server is: {SERVER},{DATABASE},{USERNAME},{PASSWORD},{DRIVER}"
